...
<section id="maincontainer" class="container clearfix">
  <h1 class="heading1">me<span>nu</span>
  </h1>
  <!-- options -->
  <section id="options" class="clearfix">
    <ul id="filters" class="option-set clearfix" data-option-key="filter">
      <li><a href="#filter" data-option-value="*" class="selected">鲁菜</a>
      </li>
      <li><a href="#filter" data-option-value=".Spicy">川菜</a>
      </li>
      <li><a href="#filter" data-option-value=".Cocktails">粤菜</a>
      </li>
      <li><a href="#filter" data-option-value=".Snacks">苏菜</a>
      </li>
      <li><a href="#filter" data-option-value=".Sea-Food">闽菜</a>
      </li>
       <li><a href="#filter" data-option-value=".Sea-Food">浙菜</a>
      </li>
       <li><a href="#filter" data-option-value=".Sea-Food">湘菜</a>
      </li>
       <li><a href="#filter" data-option-value=".Sea-Food">徽菜</a>
      </li>
    </ul>
  </section>
  <!-- Recipea -->
  <div id="recipecontainer" class="clearfix recipecolumn3 recipesortable">
    <ul>
      <li class="element  Cocktails Sea-Food">
        <a href="<%=source %>recipeimg/recipeimg3big.jpg" class="fancyboxpopup"><img src="<%=source %>recipeimg/recipeimg3.jpg" alt="" /></a>
        <div class="recipedetails">
          <a href="<%=source %>recipedetails.html" class="title">湖南鲁菜馆</a>
          <p>点击链接进去就显示这家店有什么菜，然后消费者可以下单，留言等</p>
        </div>
      </li>
      ...
      <li class="element  Cocktails Sea-Food">
        <a href="<%=source %>recipeimg/recipeimg3big.jpg" class="fancyboxpopup"><img src="<%=source %>recipeimg/recipeimg3.jpg" alt="" /></a>
        <div class="recipedetails">
          <a href="recipedetails.html" class="title">鲁菜小吃店</a>
          <p>按照菜系来显示餐馆，每家餐馆主营一种菜系</p>
        </div>
      </li>
